...
const Header = ({ logoPath }) => {
  ...
  const tweetText = encodeURIComponent("Propugnare - プログラミングバトルアプリ");
      ...
      <header className="bg-[#dc143c] text-white h-[30px]">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
          ...
          <a
            ...
            className="fixed left-4 top-4 md:right-14 md:top-6 text-xl text-gray hover:text-blue-600"
          >
            シェアする
          </a>
          ...
          <a className="fixed left-4 top-4 md:right-14 md:top-6 text-xl text-white" href="https://github.com/H-Hp/propugnare">
              <button className="fixed right-12 top-4 md:right-12 md:top-6 text-xl text-white github-button">
